...
def apply_odata_query_params(queryset: QuerySet, query_params: Dict[str, Any]) -> QuerySet:
    """
...
def get_expandable_fields_from_serializer(serializer_class) -> Dict[str, Any]:
    ...
    """
    if hasattr(serializer_class, 'Meta') and hasattr(serializer_class.Meta, 'expandable_fields'):
