...
class TestParseSelectFields:
    ...
    def test_multiple_parents_with_nested(self):
        ...
        result = parse_select_fields(
            "author.name,author.email,category.id,category.name"
        )
...
class TestParseExpandFields:
    ...
    def test_multiple_fields_with_nested_select(self):
        ...
        assert result == {"author": "name,email", "categories": None}
    ...
    def test_all_fields_with_nested_select(self):
        ...
        assert result == {"author": "name", "categories": "id,name"}
    ...
    def test_complex_expression(self):
        ...
        assert result == {"author": "name,email", "categories": "id,name", "tags": None}
...
class TestCombinedMixins:
    ...
    def test_select_and_expand_together(self):
        ...
        class TestSerializer(
            NativeFieldSelectionMixin, NativeFieldExpansionMixin, serializers.Serializer
        ):
            id = serializers.IntegerField()
            title = serializers.CharField()
            status = serializers.CharField()
        ...
        context = {
            "odata_params": {"$select": "id,title", "$expand": "author($select=name)"}
        }
