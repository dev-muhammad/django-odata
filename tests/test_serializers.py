...
from django_odata.serializers import ODataModelSerializer, ODataSerializer, create_odata_serializer
...
class SerializerRelatedModel(models.Model):
    """Related test model."""
    test_model = models.ForeignKey(SerializerTestModel, on_delete=models.CASCADE, related_name='related_items')
...
class TestODataModelSerializer(TestCase):
    ...
    def setUp(self):
        ...
        class SerializerTestModelSerializer(ODataModelSerializer):
            class Meta:
                ...
                expandable_fields = {
                    'related_items': ('tests.test_serializers.RelatedModelSerializer', {'many': True})
                }
    ...
    def test_get_navigation_properties(self):
        ...
        self.assertEqual(related_info['target_type'], 'tests.test_serializers.RelatedModelSerializer')
...
class TestCreateODataSerializer(TestCase):
    ...
    def test_create_serializer_with_fields(self):
        ...
        serializer_class = create_odata_serializer(SerializerTestModel, fields=['id', 'name', 'value'])
    ...
    def test_create_serializer_with_expandable_fields(self):
        ...
        serializer_class = create_odata_serializer(SerializerTestModel, expandable_fields=expandable_fields)
    ...
    def test_serializer_naming(self):
        ...
        serializer_class = create_odata_serializer(SerializerTestModel)
        self.assertEqual(serializer_class.__name__, 'SerializerTestModelODataSerializer')
...
class TestODataNestedExpand(TestCase):
    ...
    def test_select_and_nested_expand(self):
        ...
        expected_fields = 'id,title,status,author,posts,author.name,author.bio,posts.id,posts.title'
        self.assertEqual(
            serializer.context['request'].query_params['fields'],
            expected_fields
        )
