...
from django_odata.viewsets import ODataModelViewSet, ODataReadOnlyModelViewSet, create_odata_viewset
...
class TestCreateODataViewSet(TestCase):
    ...
    def test_create_viewset_with_custom_serializer(self):
        ...
        viewset_class = create_odata_viewset(ViewSetTestModel, serializer_class=ViewSetTestModelSerializer)
